...
describe('Register new account and verify email ', () => {
    ...
    const emailAddress = Math.random().toString(36).substring(2, 15)+"@"+ serverDomain // Email config

    it ('Registers new email and send verification link', () => {
        ...
        .type(emailAddress); // Type Email on textbox
    ...
    // Open email and verify confirmation link

    let confirmationLink
        
    cy.visit('https://mailosaur.com/app/servers/ziyvoiyo'); // Visit Test email domain
    ...
    // Retrieve email on pool message and check for email elements
    ...
    cy.mailosaurGetMessage(serverId, {
                ...
                cy.get('.heading4')
                .contains('Votre email est vérifié!');
                
                cy.get('#calltoaction-73101afc9a > .calltoaction__text')
                .contains("RETOUR À LA PAGE D'ACCUEIL");
